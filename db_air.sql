...
('K000000009', 'P001', 'B', '2022', 40, 50, 10),
('K000000010', 'P001', 'C', '2022', 50, 60, 10),
('K000000011', 'P001', 'I', '2022', 60, 70, 10);
...
('P001', 'Ahmad', 'Cimahi', '085878526041', 'Aktif', 1),
('P002', 'Budi', 'semarang', '085878526042', 'Aktif', 1),
('P003', 'Ujang', 'Cihaurbeuti', '123', 'Aktif', 1),
('P004', 'Asep', 'Sukabumi', '087789987654', 'Aktif', 1);
...
(70, '2022-05-22', 50000, 27500),
(82, '2022-05-23', 20000, 5000);
...
(70, 'K000000003', 22500, 'Lunas'),
(72, 'K000000005', 7500, 'Lunas'),
(80, 'K000000010', 15000, 'Belum Bayar'),
(82, 'K000000011', 15000, 'Lunas');
...
(1, 'Harris', 'admin', '1', 'Administrator', '085878526022', ''),
(15, 'Ahmad', 'ahmad', '1', 'Pelanggan', '085878526041', 'P001'),
(16, 'Budi', 'budi', '1', 'Pelanggan', '085878526042', 'P002'),
(20, 'Asep', 'asep', '1', 'Pelanggan', '087789987654', 'P004');
...
--
ALTER TABLE `tb_tagihan`
  MODIFY `id_tagihan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
